...
<div style="background: #f6f6f6; font-family: sans; padding: 20px 40px; width:100%;">
	<div style="background-color: #FFF;text-align: center;"><img src="http://www.legislaturasconectadas.gob.ar/static/web/images/logos/logoformulario.jpg" alt="Legislaturas Conectadas "></div>
