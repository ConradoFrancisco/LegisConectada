...
<!--===============================================-->
	...
	<ul id="sidebarnav" class="p-t-30">
		...
		<li class="sidebar-item "> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Newsletters</span></a>
			<ul aria-expanded="false" class="collapse  first-level">
				<?php if (!$this->ion_auth->is_members()):;?>
				<li class="sidebar-item">
					<a href="<?= base_url() ?>Manager/Breves/Gacetillas" class="sidebar-link"><i class="fa fa-file"></i><span class="hide-menu"> Crear Newsletters </span></a>
				</li>
				<?php endif; ?>
				<li class="sidebar-item">
					<a href="<?= base_url() ?>Manager/Breves/suscriptores" class="sidebar-link"><i class="fa fa-user-plus"></i><span class="hide-menu">Suscriptores</span></a>
				</li>
				<li class="sidebar-item">
					<a href="<?= base_url() ?>Manager/Breves/grupos" class="sidebar-link"><i class="fa fa-users"></i><span class="hide-menu">Grupos</span></a>
				</li>		
				
				<li class="sidebar-item">
					<a href="<?= base_url() ?>Manager/Breves/Newsletters" class="sidebar-link"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu"> Listar Newsletters  </span></a>
				</li>
			</ul>
		</li>
					...
					<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>Manager/Red/" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Red de Medios</span></a>

					<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>Manager/Recursos/" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Recursos Compartidos</span></a></li>
	...
	<li class="sidebar-item">
						<a href="<?= base_url('Manager/Contenidos/banners') ?>" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class=""> Banners </span></a></li>
				<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Parámetros </span></a>
					<ul aria-expanded="false" class="collapse  first-level">
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Organismos</span></a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Legislaturas" class="sidebar-link"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu">Nuevo</span></a></li>
					...
					<ul aria-expanded="false" class="collapse  first-level">
						...
						<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Localidades/" class="sidebar-link"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu"> Localidades </span></a></li>
						<!--				<li class="sidebar-item"><a href="error-405.html" class="sidebar-link"><i class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Editar </span></a></li>-->
					</ul>
				</li>
					</ul>
...
-->
		...
		<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Configuracións </span></a>
			<ul aria-expanded="false" class="collapse  first-level">
				<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Contenidos/banners" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Banners </span></a></li>
				<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Parámetros </span></a>
					<ul aria-expanded="false" class="collapse  first-level">
						<li class="sidebar-item">
						<a href="<?= base_url() ?>Manager/Tipo_publicacion" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class=""> Tipo Publicación </span></a></li>
...
-->
						...
						<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Organismos</span></a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="d-none sidebar-item"><a href="<?= base_url() ?>Manager/Categorias" class="sidebar-link"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu">Tipos de Organismos</span></a></li>	
								<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Legislaturas" class="sidebar-link"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu">Nuevo</span></a></li>
								<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Legislaturas/listado" class="sidebar-link"><i class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Listados </span></a></li>
						...
						<li class="sidebar-item"> <a class="d-none sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Concejos </span></a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Concejos" class="sidebar-link"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu">Nuevo</span></a></li>
								<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Concejos/listado" class="sidebar-link"><i class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Listados </span></a></li>
				...
				<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>Manager/Tutoriales/" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Tutoriales</span></a></li>
				<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url() ?>Manager/Backup/" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">BackUps</span></a></li>
