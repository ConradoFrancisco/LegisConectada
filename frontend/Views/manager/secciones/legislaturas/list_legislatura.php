...
<!--MODAL IMPORTAR AUTORIDADES-->

<!-- Modal -->
<div id="myModalAut" class="modal fade " role="dialog">
  <div class="modal-dialog modal-lg">

    <!-- Modal content-->
		<form action="<?php echo base_url('Manager/legislaturas/import_csv_aut'); ?>" method="post" enctype="multipart/form-data" id="form_csv_aut">
			<div class="modal-content container">
				<div class="modal-header  row">
					<div class="alert alert-info col-sm-12 text-center" role="alert">
						<h2>Importación de Autoridades </h2>
						<h3><span id="nombre_legis_aut"></span></h3>
					</div>
				<div class="alert alert-info col-sm-12" role="alert" style="text-align: center;">

				<a id="descarga_archivo" class="btn btn-default" href="<?= base_url('static/web/archivos_base/base_autoridades.xls')?>" download="xxe">Descargar Archivo Base para la carga de autoridades de:<br> <span id="arch_nombre_legis_aut"></span></a>
				</div>
				<div class="alert alert-danger col-sm-12" role="alert">
					<p>
						Los datos de autoridades existentes se eliminarán de la base de datos al confirmar la importación.
					</p>
					<p>
						Sólo se aceptan archivos con formato *.CSV	
					</p>
				...
				<div class="modal-body form-group row">
					 <input type="hidden" id="id_legislaturaAut" name="id_legislaturaAut">
					 <input type="hidden" id="delimitadorAut" name="delimitadorAut">
					<div class="col-md-12">
						<div class="custom-file">
							<input type="file" class="custom-file-input" name="fileAut"  id="csvfileAut" required="" accept=".csv">
							<label class="custom-file-label" for="validatedCustomFile">Seleccione el Archivo...</label>
						</div>
					</div>
				</div>
					...
					<div class="container">
					<div class="alert alert-warning col-sm-12 invisible" role="alert" id="msjPrev">
					Se importarán: <span id="cantRegAut"></span> registros.<br>
					</div>

					<div id="parsed_csv_list_aut"></div>

					</div>

				<div class="modal-footer container">
					<input type="submit" class="btn btn-success btn-block invisible" name="importSubmitAut" id="importSubmitAut" value="Importar">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
<!--					 <button type="button" class="btn btn-primary">Importar</button>-->
				</div>
			</div>
