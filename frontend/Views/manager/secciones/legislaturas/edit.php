...
$js = array(
	...
	<div class="form-group col-md-2">
		...
		<div class="col-md-3 ">
				...
				$attr = array(
					'class'=>'filtra_organismo select2 form-control custom-select select2-hidden-accessible'
				);
				?>

				<?= 	form_dropdown('organismo', $data_select_tipo_organismo, $legislatura->id_organismo, $attr); ?>
		...
		<?= 	form_dropdown('pais', $data_select_paises, set_value('id_pais',$legislatura->id_pais), $js); ?>
		...
		?>
		<?= 	form_dropdown('provincia', $data_select_provincia, set_value('id_provincia',$legislatura->id_provincia), $js); ?>

		<?php echo form_error('provincia','<div class="invalid-feedback" style="display:block;">',"</div>");?>
		<span class="aclaracion">* Campo requerido</span>
		</div>
		<div id="divLocalidad" class="d-none form-group  m-t-20 col-md-3">
			...
			?>
			<?= form_dropdown('id_localidad',$data_select_localidades, set_value('id_localidad',$legislatura->id_localidad), $js); ?>
			<span class="aclaracion">* Campo requerido</span>
...
//						'required'    => 	'required'
				...
				<div class="col-sm-3">
					<?php
						...
						echo form_label('LinkedIn:', 'linkedin', $data);
						$data = array(
							'name'  => 'linkedin',
							'id'    => 'linkedin',
							'class' => 'form-control ',
							'value' => $legislatura->linkedin
//						'placeholder' =>	'Detalle categoría',
//						'required'    => 	'required'
							);

							echo form_input($data);	
							echo form_error('linkedin','<div class="invalid-feedback" style="display:block;">',"</div>");
...
//						'required'    => 	'required'
		...
		<div class="row">
			...
			<div class="form-group col-lg-6 col-sm-12">
				...
				<div class="col-lg-6">
					<img class="img-fluid" src="<?= base_url($legislatura->logo)?>" alt="">
				</div>
					<?php
						$data = array(
							'class' => 'col-lg-4',
...
var idOrganismo = 	'<?= $legislatura->id_organismo?>';
