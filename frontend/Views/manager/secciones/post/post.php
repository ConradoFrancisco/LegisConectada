...
<div class="card col-md-12" id="publicacion">
	<form action="<?= base_url()?>Manager/Post" method="post" onKeypress="if(event.keyCode == 13) event.returnValue = false; " id="send_post">
						...
						<div class="card-body">
							...
							<div class="row ">
								<div class="col-md-6">
									<div class="form-group ">
										<label>Publicación de Legislaturas Conectadas: <span class="aclaracion" style="display:blocK;"></span></label>
										<?php 
												$data = array(
													'class'          => 'form-control',
													...
													'style'         => 'width: 20px; height: 20px;margin: 0 15px; display:block;'
												);
											?>
										<?= form_checkbox($data);?>
									</div>
								...
								<div class="col-md-6 mostrar_en_listdo_gral" style="display:<?= $display?>">
									<div class="form-group ">
										<label>Mostrar en link de noticias?: <span class="aclaracion" style="display:blocK;">La publicación será visible en la sección Noticias</span></label>
										<?php 
												$data = array(
													'class'          => 'form-control',
													...
													'value'         => 1,
													'checked'       => set_checkbox('mostrar_en_listado',1),
													'style'         => 'width: 20px; height: 20px;margin: 0 15px; display:block;'
												);
											?>
										<?= form_checkbox($data);?>
							...
							<div class="row">
								<div class="form-group  col-md-3">
									...
									?>
									<?= 	form_dropdown('pais', $data_select_pais, set_value('pais'), $js); ?>
								...
								<div class="form-group col-md-6">
									...
									$js['id'] = 'legis_id';
									?>
									<?= 	form_dropdown('id_legislatura', $data_select_legi, set_value('id_legislatura'), $js); ?>
							...
							<div class="form-group m-t-20">
								<label>Título: </label>
								<input onKeyDown="contar_titulo()" onKeyUp="contar_titulo()" maxlength="90" type="text" class="form-control date-inputmask" id="titulo" name="titulo" value="<?php  echo set_value('titulo');?>" >
							...
							<div class="form-group">
								...
								<textarea name="cuerpo" id="cuerpo" cols="100" rows="10"><?= set_value('cuerpo')?></textarea>
								<span class="aclaracion">* Campo requerido</span>
							</div>
							<div class="form-group">
		...
		<div class="border-top ">
			<div class="card-body">
				<button type="button" id="cargar_datos" class="btn btn-success">Enviar Datos</button>
			</div>
		</div>
