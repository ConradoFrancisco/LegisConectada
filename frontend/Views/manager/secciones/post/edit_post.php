...
<!--
	<div class="  col-md-12">
	<div class="card ">
	<div class="card-body  ">campos	</div>
	</div>
		</div>
-->
	...
	<div id="accordian-4" class="col col-md-12">
		<div class="card m-t-30 edit_post">
			<a class="card-header link" data-toggle="collapse" data-parent="#accordian-4" href="#Toggle-1" aria-expanded="true" aria-controls="Toggle-1">
				...
				<span class="titulos_accordian">Publicación</span>
			</a><form action="<?= base_url()?>Manager/Post/index/<?php echo $post->id ?>" method="post" onkeypress="if(event.keyCode == 13) event.returnValue = false;">
			<div id="Toggle-1" class="collapse  multi-collapse">
				<div class="card-body widget-content">
						...
						<div class="tab-content tabcontent-border">
							<div class="tab-pane active" id="home" role="tabpanel">
								<div class="p-20">
									<div class="card">
										<div class="card-body">
											<input type="hidden" id="id_post" name="id_post" value="<?php echo $post->id ?>" readonly>
											<input type="hidden" id="id_user_login" name="id_user_login" value="<?php echo $post->id_usuario ?>" readonly>
											<!--							<input type="hidden" id="id_legislatura" name="id_legislatura" value="<?php //echo $user->id_legislatura ?>">-->

											<div class="row">
												<div class="col-md-6">
													<div class="form-group ">
														<label style="display:block">Publicación de Legislaturas Conectadas:</label>
														<?php 
																$data = array(
								...
								<div class="col-md-6 mostrar_en_listdo_gral" style="display:<?= $display?>">
									<div class="form-group ">
										<label>Mostrar en el listado general de noticias?: <span class="aclaracion" style="display:blocK;">Seleccionar para listar en el listado general de Noticias</span></label>
										<?php 
												$data = array(
													'class'          => 'form-control',
													'name'          => 'mostrar_en_listado',
													'id'            => 'mostrar_en_listado',
													'value'         => 1,
													'checked'       => set_checkbox('mostrar_en_listado',$post->mostrar_en_listado, boolval($post->mostrar_en_listado)),
													'style'         => 'width: 20px; height: 20px;margin: 0 15px; '
												);
											?>
										<?= form_checkbox($data);?>
					...
					<div class="form-group  col-md-3">
									...
									?>
									<?= 	form_dropdown('pais', $data_select_pais, $post->id_pais, $js); ?>

								</div>					
					<?php
									
									$attr['id'] = 'legis_id';
									$attr['class'] = 'select2 form-control  select2-hidden-accessible';
									
									?>
												<div class="col-md-6">
													<div class="form-group ">
														<label>Publicación de Legislatura:</label>	
														<?= 	form_dropdown('id_legislatura', $legislatura, $post->id_legislatura, $attr); ?>
													</div>
												...
												<div id="estado_art" class="form-group col-md-3"  style="display:none">
													<label>Estado: </label>
								...
								<div class="form-group m-t-20">
												...
												<input onKeyDown="contar_titulo()" onKeyUp="contar_titulo()" maxlength="90" type="text" class="form-control date-inputmask" id="titulo" name="titulo" value="<?= $post->titulo ?>">
												<span class="aclaracion">* Campo requerido</span><br>
												<span class="aclaracion"><span id="contador">0</span> de 90 catacteres - requiere un mínimo de 35 caracteres</span>
											</div>
											<div class="form-group">
												<label>Resumen:</label>
			...
			<div id="Toggle-3" class="multi-collapse collapse" style="">
				<div class="card-body widget-content">
					...
					<form action="" id="form_cargar_video">
						<div class="row ">
...
//						'required'    => 	'required'
						...
						?>
									<div id="titulo_video_error" class="text-danger"></div>
		...
		//						'required'    => 	'required'
				...
				<div class="border-top">
					<div class="card-body">
						...
						echo form_submit('botonSubmit_addVideo', 'Enviar Video', $data);
					?>
					</div>
				</div>
			</div>
			
		<a class="card-header link border-top" data-toggle="collapse" data-parent="#accordian-4" href="#Toggle-audios" aria-expanded="true" aria-controls="Toggle-audios">
			<i class=" fab fa-soundcloud" aria-hidden="true"></i>
			<span class="titulos_accordian">Audios SoundCloud</span>
		</a>
		<div id="Toggle-audios" class="multi-collapse collapse" style="">
			<div class="card-body widget-content">
				<?php if($audios):?>
				...
				<div class="col-ls-6">
					...
					<div class="row">
						...
						<div class="col col-lg-6" id="audio_<?=$data->id_audio?>">
							<div class="card ">
								<div class="videos comment-widgets  ps-container ps-theme-default">
									<!-- Comment Row -->
									<div class="d-flex flex-row comment-row m-t-0">
									...
									<div class="comment-text w-100">
										...
										<div class="comment-footer">
											<a type="button" id="borrar_audio" data-id_audio="<?= $data->id_audio?>" class="btn btn-danger btn-sm" style="color:white;">Borrar</a>
										</div>
									</div>
								</div>
							</div>
				...
				<form action="" id="form_cargar_video">
					<div class="row ">
						...
						echo form_label('Url del audio SoundCloud:', 'url_audio', $data);
						...
						$data = array(
							...
							'id'    => 'url_audio',
							'class' => 'form-control ',
//							'value' => set_value('mi_audio'),
//						'placeholder' =>	'Detalle categoría',
//						'required'    => 	'required'
						);

						echo form_error('url_audio','<div class="invalid-feedback" style="display:block;">',"</div>");
						echo form_input($data);	
						?>
								<div id="titulo_audio_error" class="text-danger"></div>
								<span class="aclaracion">Cargue la url de iframe de audio</span>
								<div class="card-body">
									<button id="checkTouTube" onclick="buscar_audio($('#url_audio').val());" type="button" class="btn btn-secondary">Obtener iframe de audio</button>
								</div>
							</div>
						...
						echo form_label('Título del audio:', 'titulo_audio', $data);
						...
						?>
							...
							<div class="col-md-12">
								<?php
									...
									echo form_label('Detalle del audio:', 'detalle_audio', $data);
								...
								$data = array(
									...
									'id'    => 'detalle_audio',
									'class' => 'form-control ',
		//							'value' => set_value('detalle_audio'),
		//						'placeholder' =>	'Detalle categoría',
		//						'required'    => 	'required'
								);

									echo form_input($data);	
									echo form_error('detalle_audio','<div class="invalid-feedback" style="display:block;">',"</div>");
								?>
								<span class="aclaracion">Si deja vacío toma los datos de </span>
							</div>
						...
						<div class=" col-md-6 ">
							<?php
									...
									echo form_label('Captura del audio:', 'audio_post', $data);
							?>
							<div class="text-center" id="audio_post"></div>
						</div>
					</div>
			...
			<div class="border-top">
				<div class="card-body">
					<?php
						...
						echo form_submit('botonSubmit_addAudio', 'Enviar Audio', $data);
					?>
				</div>
			</div>
		</div>
