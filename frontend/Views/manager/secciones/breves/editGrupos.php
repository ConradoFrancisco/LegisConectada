...
// var_dump($grupo);?>
<script>
var datosSus = <?php echo json_encode($suscriptores); ?>;
// var datosSus = '0dsd';
</script>
...
<div class="row">
	<div class="card-body ">
		<div class="card ">
			<div class="card-body">
            <h4 class="card-title">Edición grupos de suscriptores</h4>
				<div class="row">
					<div class="col-12">
						<input readonly type="hidden" name="idGrupo" id="idGrupo" value="<?= $grupo->grupoId?>">
					...
					<div class="mt-3 col-md-3" id="editarGrupo">
