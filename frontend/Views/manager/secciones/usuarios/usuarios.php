...
<!--</div>-->
<div class="card-body">
	<h5 class="card-title m-b-0">Alta de Usuarios</h5>
	<div class="row">
		<div class="col-md-8">
		...
		<div class="form-group col-md-4">
			...
			<div class="col-md-9">
				...
				<div class=" mr-md-2">
					<input type="radio" class="custom-checkbox" name="grupo" value="<?= $group['id']?>" <?php echo set_radio('grupo', $group['id']); ?> />
	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="form-group m-t-20">
				...
				<input name="password" id="password" type="text" class="form-control" value="" readonly>
				<?php
						echo form_error('password','<div class="invalid-feedback" style="display:block;">',"</div>");
					?>
				<p>
					<span class="aclaracion">La contraseña se genera automáticamente.</span>
				</p>
				<p>
