					...
					<div class="row p-b-30">
						<div class="col-12">
							...
							<div class="input-group mb-3">
								...
								<input type="password" class="form-control form-control-lg" placeholder="su contraseña temporal" id="old" name="old" aria-label="" aria-describedby="basic-addon1" required="" value="" name="password">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="password" class="form-control form-control-lg" placeholder="Nueva Contraseña" id="new" name="new" aria-describedby="basic-addon1" required="" value="" name="password">
							</div>
							...
							<div class="input-group mb-3">
								...
								<input type="password" class="form-control form-control-lg" placeholder="Confirme Contraseña" id="new_confirm" name="new_confirm" aria-describedby="basic-addon1" required="" name="password">
							</div>
						...
						<div class="col-12">
							<div class="form-group">
								<div class="p-t-20">
									...
									<button class="btn btn-success float-right" type="submit">Cambiar Contraseña</button>
								</div>
							</div>
						</div>
					</div>
