			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9">
						<div class="business-footer-address-left">
							<ul>
								<li><a href="<?php echo base_url('Links')?>">Links de Interés</a></li>
...
-->
								<li style="display:none"><a href="<?php echo base_url('Noticias')?>">Noticias</a></li>
								<li><a href="<?php echo base_url('Legislaturas/Argentina')?>">Legislaturas</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="col-md-12 footer-info">
						<div class="container">
							<div class="row">
								...
								<div class="col-md-4">
									<div class="footer-info-left">
										<center><a href="http://www.editorialox.com/" target="_blank"><img style="max-width:50px" src="<?php echo base_url()?>static/web/images/premioaltares.png" alt="Logo"></a><br>  <b>Web premiada con el Premio Internacional OX</b></center>
									</div>
								</div>
...
<?php endif;?>
	<!-- OWL Carousel js-->
	<script src="<?= base_url()?>static/web/js/owl.carousel.min.js"></script>
	<!-- Lightbox js -->
