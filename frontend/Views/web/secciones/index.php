...
//									echo  'Poder Legislativo de la '.$slide->nombre_prov.'<br>'.$slide->nombre_pais; 
...
//									echo  '<div>'.$slide->nombre_legis.'</div>';  
								echo  wordwrap('Poder Legislativo de '.$slide->nombre_prov, 50, "<br>" ,FALSE); 
									echo '<div class="slider_pais">'.$slide->nombre_pais.'</div>';
...
-->
					<iframe width="100%" height="315" src="https://www.youtube.com/embed/g5vmeu1D2qk?controls=0&autoplay=1&showinfo=0&rel=0" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					</div>
					<!--
					...
					-->
					<div class="detalles_legislaturas_conectadas">
						<p>Legislaturas Conectadas es una red institucional  interactiva que comunica los parlamentos entre sí y con la cuidadanía.
