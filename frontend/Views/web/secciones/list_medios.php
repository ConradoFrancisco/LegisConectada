...
{
    $null = NULL;
    $str = preg_replace('/&([^;])[^;]*;/', "$1", htmlentities(mb_strtolower($str, $encoding), 0, $encoding));
    return $str;
}
                                    ...
                                    <div class="single-partner	">
                                        ...
                                        <section class="mobil d-block d-sm-none  ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 mt-2">
                                                    <figure><a href="<?= base_url($segments) ?>"><img class="img-fluid img-thumbnail" src="<?= base_url($link->link_imagen) ?>?ver=<?= time() ?>" alt="<?= $link->link_imagen ?>"> <?php //echo $countOrg; 
                                                                                                                                                                                                                                                        ?></a>
                                                    </figure>
                                                </div>
                                        ...
                                        <div class=" d-none d-sm-block media datos_legislatura <?php echo $borderDetail; ?> ">
                                            ...
                                            <div class="row " style="align-items: flex-end;">
                                                ...
                                                <div class="col-4 hover01">
                                                    <?php if ($link->link_imagen != null || $link->link_imagen != '') : ?>
                                                        <figure><a target="blank" href="<?= $link->url_link ?>"><img class="img-fluid img-thumbnail" src="<?= base_url($link->link_imagen) ?>?ver=<?= time() ?>" alt="<?= $link->nombre_localidad ?>"> <?php //echo $countOrg; 
                                                                                                                                                                                                                                                        ?></a>
                                                        </figure>
                                                    <?php endif; ?>
                                                </div>
